...
// This rule needs to be highly improved.
rule arxan_native : obfuscator
{
  meta:
    description = "Arxan"
    info = "https://www.arxan.com"

  strings:
    $jni_export_0 = "Java_xxxxxx_"
    $jni_export_1 = "Java_tttttt_"
    $jni_export_2 = "Java_oooooo_"
    $jni_export_3 = "Java_pppppp_"
